...
# Load Balancer TCP Listener variables
...
variable "check_type" {
  description = "Health check type of the load balancer tcp listener to specify which protocol would be done health check."
  default = "tcp"
}
