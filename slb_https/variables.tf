...
variable "slb_name" {
  ...
  default = "TF_Load_Balancer_HTTPS"
}
...
# Load Balancer HTTPS Listener variables
...
variable "listener_bandwidth" {
  description = "Load balancer listener bandwidth."
  default = 1
}
variable "scheduler" {
...
variable "ssl_certificate_id" {
  description = "The Server Certificate in ECS instance"
}